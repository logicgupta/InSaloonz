 ...
 * {@link MenMustacheFragmnet.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MenMustacheFragmnet#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenMustacheFragmnet extends Fragment {
     ...
     * @return A new instance of fragment MenMustacheFragmnet.
     */
    // TODO: Rename and change types and number of parameters
    public static MenMustacheFragmnet newInstance(String param1, String param2) {
        MenMustacheFragmnet fragment = new MenMustacheFragmnet();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.recyclerViewmenMustache);
        progressBar=getActivity().findViewById(R.id.progress_bar_msh3);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewmaleMustache);
        /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_men_mustache_fragmnet, container, false);
    }
    ...
    public void fetchFirebaseFemaleBeautyBleach(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.MALE_SHAVE_MUSTACHE_SALOON_KEY);
        collectionReference
