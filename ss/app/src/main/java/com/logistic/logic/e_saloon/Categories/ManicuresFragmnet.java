 ...
 * {@link ManicuresFragmnet.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ManicuresFragmnet#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ManicuresFragmnet extends Fragment {
     ...
     * @return A new instance of fragment ManicuresFragmnet.
     */
    // TODO: Rename and change types and number of parameters
    public static ManicuresFragmnet newInstance(String param1, String param2) {
        ManicuresFragmnet fragment = new ManicuresFragmnet();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleNailManicure);
        progressBar=getActivity().findViewById(R.id.progress_bar_fn1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewNailManicure);
        /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_manicures_fragmnet, container, false);
    }
    ...
    public void fetchFirebaseFemaleBeautyBleach(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.FEMALE_NAIL_MANICURE_SALOON_KEY);
