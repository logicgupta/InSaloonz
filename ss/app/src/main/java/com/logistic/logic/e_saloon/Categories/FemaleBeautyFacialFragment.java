 ...
 * {@link FemaleBeautyFacialFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FemaleBeautyFacialFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FemaleBeautyFacialFragment extends Fragment {
    ...
    public FemaleBeautyFacialFragment() {
     ...
     * @return A new instance of fragment FemaleBeautyFacialFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FemaleBeautyFacialFragment newInstance(String param1, String param2) {
        FemaleBeautyFacialFragment fragment = new FemaleBeautyFacialFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fetchFirebaseFemaleBeautyFacial();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_female_beauty_facial, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {

        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleBeautyFacial);
        progressBar=getActivity().findViewById(R.id.progress_bar_fb1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewFFacial);
