 ...
 * {@link MenShaveFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MenShaveFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenShaveFragment extends Fragment {
     ...
     * @return A new instance of fragment MenShaveFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MenShaveFragment newInstance(String param1, String param2) {
        MenShaveFragment fragment = new MenShaveFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.recyclerViewmenShave);
        progressBar=getActivity().findViewById(R.id.progress_bar_msh1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewmaleShave);
        /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_men_shave, container, false);
    }
    ...
    public void fetchFirebaseFemaleBeautyBleach(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.MALE_SHAVE_BEARED_SALOON_KEY);
