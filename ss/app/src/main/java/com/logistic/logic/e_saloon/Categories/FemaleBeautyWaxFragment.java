 ...
 * {@link FemaleBeautyWaxFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FemaleBeautyWaxFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FemaleBeautyWaxFragment extends Fragment {
    ...
    public FemaleBeautyWaxFragment() {
     ...
     * @return A new instance of fragment FemaleBeautyWaxFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FemaleBeautyWaxFragment newInstance(String param1, String param2) {
        FemaleBeautyWaxFragment fragment = new FemaleBeautyWaxFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_female_beauty_wax, container, false);
    }

    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {

        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleBeautyWax);
        progressBar=getActivity().findViewById(R.id.progress_bar_fb4);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewFWax);
