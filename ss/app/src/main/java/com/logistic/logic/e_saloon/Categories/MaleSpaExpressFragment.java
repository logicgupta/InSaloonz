 ...
 * {@link MaleSpaExpressFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MaleSpaExpressFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MaleSpaExpressFragment extends Fragment {
     ...
     * @return A new instance of fragment MaleSpaExpressFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MaleSpaExpressFragment newInstance(String param1, String param2) {
        MaleSpaExpressFragment fragment = new MaleSpaExpressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_male_spa_express, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {

        recyclerView=getActivity().findViewById(R.id.recyclerViewmaleSpaExpress);
        progressBar=getActivity().findViewById(R.id.progress_bar_ms1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewMExpress);
