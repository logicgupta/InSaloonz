 ...
 * {@link PedicuresFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PedicuresFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PedicuresFragment extends Fragment {
     ...
     * @return A new instance of fragment PedicuresFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PedicuresFragment newInstance(String param1, String param2) {
        PedicuresFragment fragment = new PedicuresFragment();
    ...
    recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleNailPedicure);
    progressBar=getActivity().findViewById(R.id.progress_bar_fn2);
    showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewNailPadicure);
    /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pedicures, container, false);
    }
    ...
    public void fetchFirebaseFemaleBeautyBleach(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.FEMALE_NAIL_PADICURE_SALOON_KEY);
