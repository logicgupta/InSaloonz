 ...
 * {@link SculturedNailFragmnet.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SculturedNailFragmnet#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SculturedNailFragmnet extends Fragment {
     ...
     * @return A new instance of fragment SculturedNailFragmnet.
     */
    // TODO: Rename and change types and number of parameters
    public static SculturedNailFragmnet newInstance(String param1, String param2) {
        SculturedNailFragmnet fragment = new SculturedNailFragmnet();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleNailScultured);
        progressBar=getActivity().findViewById(R.id.progress_bar_fb2);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewNailScultured);
        /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_scultured_nail_fragmnet, container, false);
    }
    ...
    public void fetchFirebaseFemaleBeautyBleach(){
        ...
        collectionReference=firestore
                ...
                .document(ConfigName.FEMALE_NAIL_KEY)
                .collection(ConfigName.FEMALE_NAIL_SCULPTURE_SALOON_KEY);
