 ...
 * {@link FemaleSpaExpressFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FemaleSpaExpressFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FemaleSpaExpressFragment extends Fragment {
    ...
    public FemaleSpaExpressFragment() {
     ...
     * @return A new instance of fragment FemaleSpaExpressFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FemaleSpaExpressFragment newInstance(String param1, String param2) {
        FemaleSpaExpressFragment fragment = new FemaleSpaExpressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_female_spa_express, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleSpaExpress);
        progressBar=getActivity().findViewById(R.id.progress_bar_fs1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewFExpress);
