 ...
 * {@link BookedAppointment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BookedAppointment#newInstance} factory method to
...
public class BookedAppointment extends Fragment {
     ...
     * @return A new instance of fragment BookedAppointment.
     */
    // TODO: Rename and change types and number of parameters
    public static BookedAppointment newInstance(String param1, String param2) {
        BookedAppointment fragment = new BookedAppointment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.bookedAppointmentRecyclerView);
        progressBar=getActivity().findViewById(R.id.bookedAppointmentProgressBar);
        statusTextView=getActivity().findViewById(R.id.bookedAppointmentTextView);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for (QueryDocumentSnapshot snapshot :task.getResult()){
                        ...
                        appointment1.setKey(snapshot.getId());
                    ...
                    if (appointment1List.isEmpty()){
                        Toast.makeText(getActivity(), "No Appointments Done !", Toast.LENGTH_SHORT).show();
                    }
                    recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                    MyRecyclerBookedAdapter adapter=
                            new MyRecyclerBookedAdapter(getActivity()
