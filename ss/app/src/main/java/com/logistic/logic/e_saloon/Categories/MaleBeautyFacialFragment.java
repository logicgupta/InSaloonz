 ...
 * {@link MaleBeautyFacialFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MaleBeautyFacialFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MaleBeautyFacialFragment extends Fragment {
    ...
    public MaleBeautyFacialFragment() {
     ...
     * @return A new instance of fragment MaleBeautyFacialFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MaleBeautyFacialFragment newInstance(String param1, String param2) {
        MaleBeautyFacialFragment fragment = new MaleBeautyFacialFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_male_beauty_facial, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        recyclerView=getActivity().findViewById(R.id.recyclerViewmaleBeautyFacial);
        progressBar=getActivity().findViewById(R.id.progress_bar_mb1);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewMFacial);

    }

    public void fetchFirebaseMaleBeautyFacial(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.MALE_BEAUTY_FACIAL_SALOON_KEY);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for (QueryDocumentSnapshot snapshot : task.getResult()){
                        ...
                        Log.e("male Beauty  Facial"," "+snapshot.getData());
