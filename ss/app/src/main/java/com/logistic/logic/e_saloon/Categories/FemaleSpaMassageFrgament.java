 ...
 * {@link FemaleSpaMassageFrgament.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FemaleSpaMassageFrgament#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FemaleSpaMassageFrgament extends Fragment {
    ...
    public FemaleSpaMassageFrgament() {
     ...
     * @return A new instance of fragment FemaleSpaMassageFrgament.
     */
    // TODO: Rename and change types and number of parameters
    public static FemaleSpaMassageFrgament newInstance(String param1, String param2) {
        FemaleSpaMassageFrgament fragment = new FemaleSpaMassageFrgament();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_female_spa_massage_frgament, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {

        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleSpaMassage);
        final LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
        progressBar=getActivity().findViewById(R.id.progress_bar_fs2);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewFMassage);
