 ...
 * {@link HairColorStyleFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HairColorStyleFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HairColorStyleFragment extends Fragment {
    ...
    public HairColorStyleFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static HairColorStyleFragment newInstance(String param1, String param2) {
        HairColorStyleFragment fragment = new HairColorStyleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_hair_color_style, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView=getActivity().findViewById(R.id.recyclerViewfemaleHairColor);
        progressBar=getActivity().findViewById(R.id.progress_bar_fh2);
        showNoServiceStatus=getActivity().findViewById(R.id.noServiceTextViewFColor);


    }

    public void fetchFirebaseFemaleHairColor(){
        ...
        collectionReference=firestore
                ...
                .collection(ConfigName.FEMALE_HAIR_COLOR_SALOON_KEY);
